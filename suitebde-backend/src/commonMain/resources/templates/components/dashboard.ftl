<#macro stripeAlert>
    <div class="mb-3 flex w-full border-l-6 border-warning bg-warning bg-opacity-[15%] px-7 py-8 shadow-md dark:bg-[#1B1B24] dark:bg-opacity-30 md:p-9">
        ...
        <div class="w-full">
            <h5 class="mb-3 text-lg font-bold text-[#9D5425]"><@t key="admin_stripe_alert_title" /></h5>
            <p class="mb-3 leading-relaxed text-[#D0915C]"><@t key="admin_stripe_alert_content" /></p>
            <a href="/admin/settings"
               class="inline-flex items-center justify-center rounded-md bg-black py-4 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-10">
                <@t key="admin_stripe_alert_title" />
            </a>
        </div>
    </div>
</#macro>
