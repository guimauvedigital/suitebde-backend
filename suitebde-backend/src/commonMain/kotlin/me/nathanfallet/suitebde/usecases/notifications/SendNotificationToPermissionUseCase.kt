...
class SendNotificationToPermissionUseCase(
...
) : ISendNotificationToPermissionUseCase {

    override suspend fun invoke(input: CreatePermissionNotificationPayload) {
        CoroutineScope(Job()).launch {
            repository.listByPermission(input.permission).forEach {
                try {
